...
# Provide reusable review guidance for the Evaluator. This skill does not define governance thresholds or scoring weights; those are supplied by the active governance policy.
